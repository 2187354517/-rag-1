  ...
  <div class="chat-assistant">
    ...
    <div class="assistant-container">
      <div v-if="hasThinkCard">
        <el-button class="thinking-button" style="border-radius: 6px" type="primary" text bg size="small"
          @click="toggle()">
          <span v-if="isStream">思考中……</span>
          <span v-else>已思考（用时 {{ streamtime.diffTime }} 秒）</span>
          <el-icon class="el-icon--right" v-if="isThinkHidden">
            <ArrowDown />
          </el-icon>
        ...
        <div ref="box" class="think-container" :class="{ 'think-hidden': isThinkHidden }">
          <section class="trigger-section">
            ...
            <el-button v-if="think" class="thinking-button" type="primary" text bg circle icon="ArrowUp" size="small"
      ...
      <div v-if="error">
        <el-text size="large">{{ errorContent }}
          <ErrorIcon style="margin-left: 10px" />
        </el-text>
      </div>
